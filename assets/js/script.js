...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Krishiv Dhanania";
...
fetch('./assets/js/projects.json')
    ...
    <div class="box">
        ...
        <div class="btns">
            ...
            <a href="https://github.com/Krishiv Dhanania/JavaScript-Projects/tree/main/projects/${proj.meta}" class="btn" target="_blank">Code <i class="fas fa-code"></i></a>
        </div>
        </div>
    </div>`;
        });
